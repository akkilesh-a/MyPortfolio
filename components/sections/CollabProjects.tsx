...
export function CollabProjects() {
  return (
    <VortexWrapper>
      ...
      <Heading text={"Things I've worked on!"}/>
      <div className="flex flex-wrap px-8 sm:gap-4 justify-around">
        {collabProjectItems.map((item,index)=>{
          return(
            <CardContainer key={index} className="inter-var">
              <CardBody className=" relative group/card  hover:shadow-2xl hover:shadow-emerald-500/[0.1] bg-black-100 border-white/[0.2] w-auto sm:w-[25rem] h-auto rounded-xl p-6 border  ">
                <CardItem
                  translateZ="50"
